...
async def translate_callback(call: CallbackQuery, state: FSMContext):
    ...
    await call.message.edit_text("Чтобы изменить язык нажмите на кнопку ниже 👇", reply_markup=btn)
    await call.message.answer("Введите <u><b>текст</b></u>, который хотите <u><b>перевести.</b></u>")
